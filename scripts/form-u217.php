...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NOMBRE:</b></td><td>' . htmlentities($_REQUEST["custom_U222"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MENSAJE:</b></td><td>' . htmlentities($_REQUEST["custom_U218"],ENT_COMPAT,'UTF-8') . '</td></tr>';
