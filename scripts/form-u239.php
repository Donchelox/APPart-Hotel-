...
function emailFormSubmission()
{
	...
	$to = 'inside.4.me@gmail.com';
	$subject = 'Envío de Formulario MUCAMA';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NOMBRE:</b></td><td>' . htmlentities($_REQUEST["custom_U252"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>PIEZA:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MENSAJE:</b></td><td>' . htmlentities($_REQUEST["custom_U240"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: inside.4.me@gmail.com' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.30 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
